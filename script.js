...
class Calculator {
    ...
    addNumber(number) {
        if(this.currentOperand.length > 9) this.currentOperands.style.fontSize = '1.7rem'
        if(this.currentOperand.length > 12 || this.previousOperand.length > 20) return
    ...
    updateDisplay() {
        ...
        if(this.operation != null) {
            this.previousOperands.innerText = `${this.getDisplayNumber(this.previousOperand)} ${this.operation} ${this.currentOperand}`
        } else {
